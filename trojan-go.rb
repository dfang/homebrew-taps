...
class TrojanGo < Formula
  ...
  plist_options :manual => "trojan-go -config #{ENV["HOME"]}/.config/trojan-go/config.json"
      ...
      <plist version="1.0">
        <dict>
          ...
          <array>
            ...
            <string>#{ENV["HOME"]}/.config/trojan-go/config.json</string>
          </array>
          <key>StandardErrorPath</key>
          <string>/usr/local/var/log/trojan-go.log</string>
